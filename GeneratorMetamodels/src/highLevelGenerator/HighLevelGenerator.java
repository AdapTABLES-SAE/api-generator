...
public class HighLevelGenerator {
	...
	public HighLevelGenerator() {
		resourceSet = new ResourceSetImpl();
	}
	
	public static void main(String[] args) {
		new HighLevelGenerator().start(); 
	}
	...
	private void selectRoomsPercentages() {
		highLevelActivity.addRoomPercentage(Map.entry(RoomType.DOOR, 100));
	}
	...
	private void loadInputModels() {
		...
		this.knowledge = (Knowledge) resource1.getContents().get(0);
