 ...
 * </p>
 * <ul>
 *   <li>{@link generatorMetamodels.impl.MultipleChoiceImpl#getNbChoices <em>Nb Choices</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MultipleChoiceImpl extends ResponseModalityImpl implements MultipleChoice {
	...
	protected EClass eStaticClass() {
		return GeneratorMetamodelsPackage.Literals.MULTIPLE_CHOICE;
	}
	...
	public void setNbChoices(int newNbChoices) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					GeneratorMetamodelsPackage.MULTIPLE_CHOICE__NB_CHOICES, oldNbChoices, nbChoices));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case GeneratorMetamodelsPackage.MULTIPLE_CHOICE__NB_CHOICES:
			return getNbChoices();
		}
