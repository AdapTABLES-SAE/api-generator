 ...
 * </p>
 * <ul>
 *   <li>{@link generatorMetamodels.impl.LearningPathsImpl#getLearningpaths <em>Learningpaths</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LearningPathsImpl extends MinimalEObjectImpl.Container implements LearningPaths {
	...
	protected EClass eStaticClass() {
		return GeneratorMetamodelsPackage.Literals.LEARNING_PATHS;
	}
	...
	public EList<LearningPath> getLearningpaths() {
		if (learningpaths == null) {
			learningpaths = new EObjectContainmentEList<LearningPath>(LearningPath.class, this,
					GeneratorMetamodelsPackage.LEARNING_PATHS__LEARNINGPATHS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case GeneratorMetamodelsPackage.LEARNING_PATHS__LEARNINGPATHS:
