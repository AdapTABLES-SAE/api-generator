 ...
 * </p>
 * <ul>
 *   <li>{@link generatorMetamodels.impl.SetOfFactsImpl#getFacts <em>Facts</em>}</li>
 *   <li>{@link generatorMetamodels.impl.SetOfFactsImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SetOfFactsImpl extends AbstractFactImpl implements SetOfFacts {
	...
	protected EClass eStaticClass() {
		return GeneratorMetamodelsPackage.Literals.SET_OF_FACTS;
	}
	...
	public EList<AbstractFact> getFacts() {
		if (facts == null) {
			facts = new EObjectContainmentEList<AbstractFact>(AbstractFact.class, this,
					GeneratorMetamodelsPackage.SET_OF_FACTS__FACTS);
		}
		return facts;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorMetamodelsPackage.SET_OF_FACTS__NAME,
					oldName, name));
	}
