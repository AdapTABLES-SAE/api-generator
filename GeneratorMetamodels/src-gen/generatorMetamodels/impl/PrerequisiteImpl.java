 ...
 * </p>
 * <ul>
 *   <li>{@link generatorMetamodels.impl.PrerequisiteImpl#getSuccessPercentage <em>Success Percentage</em>}</li>
 *   <li>{@link generatorMetamodels.impl.PrerequisiteImpl#getPrerequisite <em>Prerequisite</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrerequisiteImpl extends MinimalEObjectImpl.Container implements Prerequisite {
	...
	protected EClass eStaticClass() {
		return GeneratorMetamodelsPackage.Literals.PREREQUISITE;
	}
	...
	public void setSuccessPercentage(int newSuccessPercentage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					GeneratorMetamodelsPackage.PREREQUISITE__SUCCESS_PERCENTAGE, oldSuccessPercentage,
					successPercentage));
	}
			...
			if (prerequisite != oldPrerequisite) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GeneratorMetamodelsPackage.PREREQUISITE__PREREQUISITE, oldPrerequisite, prerequisite));
			}
		}
		return prerequisite;
	}
	...
	public void setPrerequisite(Level newPrerequisite) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorMetamodelsPackage.PREREQUISITE__PREREQUISITE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case GeneratorMetamodelsPackage.PREREQUISITE__SUCCESS_PERCENTAGE:
			return getSuccessPercentage();
		case GeneratorMetamodelsPackage.PREREQUISITE__PREREQUISITE:
			if (resolve)
