 ...
 * </p>
 * <ul>
 *   <li>{@link demo.impl.LearningObjectiveImpl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LearningObjectiveImpl extends MinimalEObjectImpl.Container implements LearningObjective {
	...
	protected EClass eStaticClass() {
		return DemoPackage.Literals.LEARNING_OBJECTIVE;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DemoPackage.LEARNING_OBJECTIVE__DESCRIPTION,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case DemoPackage.LEARNING_OBJECTIVE__DESCRIPTION:
