...
public interface GeneratorPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int ATASK___GET_NB_EXPECTED_ANSWERS = 2;
	...
	/**
	 * The feature id for the '<em><b>Map Value</b></em>' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int ENTRY_SOLUCE_PARAM__MAP_VALUE = PARAMETER_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int ORDERING_TASK___GET_NB_EXPECTED_ANSWERS = ATASK___GET_NB_EXPECTED_ANSWERS;
	 ...
	 * @ordered
	 */
	int ORDERING_TASK___NB_EXPECTED_ANSWERS = ATASK_OPERATION_COUNT + 0;
	...
	/**
	 * The meta object id for the '{@link generator.impl.MapImpl <em>Map</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see generator.impl.MapImpl
	 ...
	 * @ordered
	 */
	int MAP__POSITIONS = IMAGE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int MAP_FEATURE_COUNT = IMAGE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int MAP_OPERATION_COUNT = IMAGE_OPERATION_COUNT + 0;

	/**
	 * The meta object id for the '{@link generator.impl.MapElementPositionImpl <em>Map Element Position</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see generator.impl.MapElementPositionImpl
	 ...
	 * @ordered
	 */
	int MAP_ELEMENT_POSITION__ID = 0;

	/**
	 * The number of structural features of the '<em>Map Element Position</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int MAP_ELEMENT_POSITION_FEATURE_COUNT = 1;

	/**
	 * The number of operations of the '<em>Map Element Position</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int MAP_ELEMENT_POSITION_OPERATION_COUNT = 0;
	 ...
	 * @ordered
	 */
	int DATE_OPERATION_COUNT = TIME_OPERATION_COUNT + 0;
	...
	/**
	 * The meta object id for the '{@link generator.impl.MapValueImpl <em>Map Value</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see generator.impl.MapValueImpl
	 ...
	 * @ordered
	 */
	int MAP_VALUE__VALUE = VALUE__VALUE;
	...
	/**
	 * The operation id for the '<em>Is Correct Value</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int MAP_VALUE___IS_CORRECT_VALUE = VALUE_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int MAP_VALUE_OPERATION_COUNT = VALUE_OPERATION_COUNT + 1;
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see generator.impl.HAssociationImpl
	 ...
	 * @ordered
	 */
	int HASSOCIATION__PERCENT_OF_APPARITION = COMPLETION_TASK__PERCENT_OF_APPARITION;
	 ...
	 * @ordered
	 */
	int HASSOCIATION__NB_CONSECUTIVE_SUCCESS = COMPLETION_TASK__NB_CONSECUTIVE_SUCCESS;
	 ...
	 * @ordered
	 */
	int HASSOCIATION__RESPONSE_MODALITY = COMPLETION_TASK__RESPONSE_MODALITY;
	 ...
	 * @ordered
	 */
	int HASSOCIATION__ID = COMPLETION_TASK__ID;
	 ...
	 * @ordered
	 */
	int HASSOCIATION__MAX_TIME = COMPLETION_TASK__MAX_TIME;
	 ...
	 * @ordered
	 */
	int HASSOCIATION__NB_FACTS = COMPLETION_TASK__NB_FACTS;
	 ...
	 * @ordered
	 */
	int HASSOCIATION___GET_TYPE = COMPLETION_TASK___GET_TYPE;
	 ...
	 * @ordered
	 */
	int HASSOCIATION___IS_CHECK_ON_LEARNER_ACTION = COMPLETION_TASK___IS_CHECK_ON_LEARNER_ACTION;
	 ...
	 * @ordered
	 */
	int HASSOCIATION___IS_GRAPHIC_TASK = COMPLETION_TASK___IS_GRAPHIC_TASK;
	 ...
	 * @ordered
	 */
	int HASSOCIATION___GET_NB_MISSING_ELEMENTS = COMPLETION_TASK___GET_NB_MISSING_ELEMENTS;
	 ...
	 * @ordered
	 */
	int HASSOCIATION___GET_NB_EXPECTED_ANSWERS = COMPLETION_TASK___GET_NB_EXPECTED_ANSWERS;

	/**
	 * The number of operations of the '<em>HAssociation</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int HASSOCIATION_OPERATION_COUNT = COMPLETION_TASK_OPERATION_COUNT + 0;

	/**
	 * The meta object id for the '{@link generator.impl.HLegendImpl <em>HLegend</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see generator.impl.HLegendImpl
	 ...
	 * @ordered
	 */
	int HLEGEND__PERCENT_OF_APPARITION = COMPLETION_TASK__PERCENT_OF_APPARITION;
	 ...
	 * @ordered
	 */
	int HLEGEND__NB_CONSECUTIVE_SUCCESS = COMPLETION_TASK__NB_CONSECUTIVE_SUCCESS;
	 ...
	 * @ordered
	 */
	int HLEGEND__RESPONSE_MODALITY = COMPLETION_TASK__RESPONSE_MODALITY;
	 ...
	 * @ordered
	 */
	int HLEGEND__ID = COMPLETION_TASK__ID;
	 ...
	 * @ordered
	 */
	int HLEGEND__MAX_TIME = COMPLETION_TASK__MAX_TIME;
	 ...
	 * @ordered
	 */
	int HLEGEND__NB_FACTS = COMPLETION_TASK__NB_FACTS;
	 ...
	 * @ordered
	 */
	int HLEGEND__TYPE = COMPLETION_TASK__TYPE;
	 ...
	 * @ordered
	 */
	int HLEGEND__NB_MISSING_ELEMENTS = COMPLETION_TASK_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int HLEGEND__MISSING = COMPLETION_TASK_FEATURE_COUNT + 1;

	/**
	 * The number of structural features of the '<em>HLegend</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int HLEGEND_FEATURE_COUNT = COMPLETION_TASK_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int HLEGEND___GET_TYPE = COMPLETION_TASK___GET_TYPE;
	 ...
	 * @ordered
	 */
	int HLEGEND___IS_CHECK_ON_LEARNER_ACTION = COMPLETION_TASK___IS_CHECK_ON_LEARNER_ACTION;
	 ...
	 * @ordered
	 */
	int HLEGEND___IS_GRAPHIC_TASK = COMPLETION_TASK___IS_GRAPHIC_TASK;
	 ...
	 * @ordered
	 */
	int HLEGEND___GET_NB_MISSING_ELEMENTS = COMPLETION_TASK___GET_NB_MISSING_ELEMENTS;
	 ...
	 * @ordered
	 */
	int HLEGEND___GET_NB_EXPECTED_ANSWERS = COMPLETION_TASK___GET_NB_EXPECTED_ANSWERS;

	/**
	 * The number of operations of the '<em>HLegend</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int HLEGEND_OPERATION_COUNT = COMPLETION_TASK_OPERATION_COUNT + 0;

	/**
	 * The meta object id for the '{@link generator.impl.GLocateImpl <em>GLocate</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see generator.impl.GLocateImpl
	 ...
	 * @ordered
	 */
	int GLOCATE__PERCENT_OF_APPARITION = MEMBERSHIP_ID_TASK__PERCENT_OF_APPARITION;
	 ...
	 * @ordered
	 */
	int GLOCATE__NB_CONSECUTIVE_SUCCESS = MEMBERSHIP_ID_TASK__NB_CONSECUTIVE_SUCCESS;
	 ...
	 * @ordered
	 */
	int GLOCATE__RESPONSE_MODALITY = MEMBERSHIP_ID_TASK__RESPONSE_MODALITY;
	 ...
	 * @ordered
	 */
	int GLOCATE__ID = MEMBERSHIP_ID_TASK__ID;
	 ...
	 * @ordered
	 */
	int GLOCATE__MAX_TIME = MEMBERSHIP_ID_TASK__MAX_TIME;
	 ...
	 * @ordered
	 */
	int GLOCATE__NB_FACTS = MEMBERSHIP_ID_TASK__NB_FACTS;
	 ...
	 * @ordered
	 */
	int GLOCATE__TYPE = MEMBERSHIP_ID_TASK__TYPE;
	 ...
	 * @ordered
	 */
	int GLOCATE__IDENTIFY_SHARED_PROPERTY = MEMBERSHIP_ID_TASK__IDENTIFY_SHARED_PROPERTY;
	 ...
	 * @ordered
	 */
	int GLOCATE__CHECK_LEARNER_ACTION = MEMBERSHIP_ID_TASK__CHECK_LEARNER_ACTION;
	 ...
	 * @ordered
	 */
	int GLOCATE__NB_EXPECTED_ANSWERS = MEMBERSHIP_ID_TASK_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int GLOCATE__LEARNERS_CHOICES = MEMBERSHIP_ID_TASK_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int GLOCATE__GRAPHIC_TASK = MEMBERSHIP_ID_TASK_FEATURE_COUNT + 2;

	/**
	 * The number of structural features of the '<em>GLocate</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int GLOCATE_FEATURE_COUNT = MEMBERSHIP_ID_TASK_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int GLOCATE___GET_TYPE = MEMBERSHIP_ID_TASK___GET_TYPE;
	 ...
	 * @ordered
	 */
	int GLOCATE___IS_CHECK_ON_LEARNER_ACTION = MEMBERSHIP_ID_TASK___IS_CHECK_ON_LEARNER_ACTION;
	 ...
	 * @ordered
	 */
	int GLOCATE___IS_GRAPHIC_TASK = MEMBERSHIP_ID_TASK___IS_GRAPHIC_TASK;
	 ...
	 * @ordered
	 */
	int GLOCATE___GET_NB_EXPECTED_ANSWERS = MEMBERSHIP_ID_TASK___GET_NB_EXPECTED_ANSWERS;

	/**
	 * The number of operations of the '<em>GLocate</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int GLOCATE_OPERATION_COUNT = MEMBERSHIP_ID_TASK_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int MAP_QUESTIONABLE_FACT_FEATURE_COUNT = AQUESTIONABLE_FACT_FEATURE_COUNT + 3;
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see generator.impl.MapSolutionImpl
	 * @see generator.impl.GeneratorPackageImpl#getMapSolution()
	 * @generated
	 */
	int MAP_SOLUTION = 117;
	 ...
	 * @ordered
	 */
	int MAP_SOLUTION__VALUE = 0;

	/**
	 * The feature id for the '<em><b>Map Position</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int MAP_SOLUTION__MAP_POSITION = 1;

	/**
	 * The number of structural features of the '<em>Map Solution</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int MAP_SOLUTION_FEATURE_COUNT = 2;

	/**
	 * The number of operations of the '<em>Map Solution</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int MAP_SOLUTION_OPERATION_COUNT = 0;
	...
	/**
	 * Returns the meta object for the containment reference '{@link generator.SetOfFacts#getMap <em>Map</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Map</em>'.
	 * @see generator.SetOfFacts#getMap()
	 * @see #getSetOfFacts()
	 * @generated
	 */
	EReference getSetOfFacts_Map();
	...
	/**
	 * Returns the meta object for class '{@link generator.Map <em>Map</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference list '{@link generator.Map#getPositions <em>Positions</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Positions</em>'.
	 * @see generator.Map#getPositions()
	 * @see #getMap()
	 * @generated
	 */
	EReference getMap_Positions();

	/**
	 * Returns the meta object for class '{@link generator.MapElementPosition <em>Map Element Position</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Map Element Position</em>'.
	 * @see generator.MapElementPosition
	 * @generated
	 */
	EClass getMapElementPosition();

	/**
	 * Returns the meta object for the attribute '{@link generator.MapElementPosition#getID <em>ID</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>ID</em>'.
	 * @see generator.MapElementPosition#getID()
	 * @see #getMapElementPosition()
	 * @generated
	 */
	EAttribute getMapElementPosition_ID();
	...
	/**
	 * Returns the meta object for class '{@link generator.MapValue <em>Map Value</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the '{@link generator.MapValue#isCorrectValue() <em>Is Correct Value</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Is Correct Value</em>' operation.
	 * @see generator.MapValue#isCorrectValue()
	 * @generated
	 */
	EOperation getMapValue__IsCorrectValue();
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>HAssociation</em>'.
	 ...
	 * @see generator.HAssociation#getSource()
	 * @see #getHAssociation()
	 * @generated
	 */
	EAttribute getHAssociation_Source();

	/**
	 * Returns the meta object for the attribute '{@link generator.HAssociation#getMissing <em>Missing</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Missing</em>'.
	 * @see generator.HAssociation#getMissing()
	 * @see #getHAssociation()
	 * @generated
	 */
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>HLegend</em>'.
	...
	/**
	 * Returns the meta object for the attribute '{@link generator.HLegend#getNbMissingElements <em>Nb Missing Elements</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Nb Missing Elements</em>'.
	 * @see generator.HLegend#getNbMissingElements()
	 * @see #getHLegend()
	 * @generated
	 */
	EAttribute getHLegend_NbMissingElements();

	/**
	 * Returns the meta object for the attribute '{@link generator.HLegend#getMissing <em>Missing</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Missing</em>'.
	 * @see generator.HLegend#getMissing()
	 * @see #getHLegend()
	 * @generated
	 */
	EAttribute getHLegend_Missing();

	/**
	 * Returns the meta object for class '{@link generator.GLocate <em>GLocate</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>GLocate</em>'.
	...
	/**
	 * Returns the meta object for the attribute '{@link generator.GLocate#getNbExpectedAnswers <em>Nb Expected Answers</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Nb Expected Answers</em>'.
	 * @see generator.GLocate#getNbExpectedAnswers()
	 * @see #getGLocate()
	 * @generated
	 */
	EAttribute getGLocate_NbExpectedAnswers();

	/**
	 * Returns the meta object for the attribute '{@link generator.GLocate#isLearnersChoices <em>Learners Choices</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Learners Choices</em>'.
	 * @see generator.GLocate#isLearnersChoices()
	 * @see #getGLocate()
	 * @generated
	 */
	EAttribute getGLocate_LearnersChoices();

	/**
	 * Returns the meta object for the attribute '{@link generator.GLocate#isGraphicTask <em>Graphic Task</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Graphic Task</em>'.
	 * @see generator.GLocate#isGraphicTask()
	 * @see #getGLocate()
	 * @generated
	 */
	EAttribute getGLocate_GraphicTask();
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Map Solution</em>'.
	 * @see generator.MapSolution
	 * @generated
	 */
	EClass getMapSolution();

	/**
	 * Returns the meta object for the attribute '{@link generator.MapSolution#getValue <em>Value</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Value</em>'.
	 * @see generator.MapSolution#getValue()
	 * @see #getMapSolution()
	 * @generated
	 */
	EAttribute getMapSolution_Value();

	/**
	 * Returns the meta object for the reference '{@link generator.MapSolution#getMapPosition <em>Map Position</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Map Position</em>'.
	 * @see generator.MapSolution#getMapPosition()
	 * @see #getMapSolution()
	 * @generated
	 */
	EReference getMapSolution_MapPosition();
	...
	/**
	 * Returns the meta object for the containment reference '{@link generator.EntrySoluceParam#getMapValue <em>Map Value</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Map Value</em>'.
	 * @see generator.EntrySoluceParam#getMapValue()
	 * @see #getEntrySoluceParam()
	 * @generated
	 */
	EReference getEntrySoluceParam_MapValue();
	...
	/**
	 * Returns the meta object for the '{@link generator.OrderingTask#nbExpectedAnswers() <em>Nb Expected Answers</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Nb Expected Answers</em>' operation.
	 * @see generator.OrderingTask#nbExpectedAnswers()
	 * @generated
	 */
	EOperation getOrderingTask__NbExpectedAnswers();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference SET_OF_FACTS__MAP = eINSTANCE.getSetOfFacts_Map();
		...
		/**
		 * The meta object literal for the '{@link generator.impl.MapImpl <em>Map</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see generator.impl.MapImpl
		 * @see generator.impl.GeneratorPackageImpl#getMap()
		 ...
		 * @generated
		 */
		EReference MAP__POSITIONS = eINSTANCE.getMap_Positions();

		/**
		 * The meta object literal for the '{@link generator.impl.MapElementPositionImpl <em>Map Element Position</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see generator.impl.MapElementPositionImpl
		 * @see generator.impl.GeneratorPackageImpl#getMapElementPosition()
		 * @generated
		 */
		EClass MAP_ELEMENT_POSITION = eINSTANCE.getMapElementPosition();
		 ...
		 * @generated
		 */
		EAttribute MAP_ELEMENT_POSITION__ID = eINSTANCE.getMapElementPosition_ID();
		...
		/**
		 * The meta object literal for the '{@link generator.impl.MapValueImpl <em>Map Value</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see generator.impl.MapValueImpl
		 * @see generator.impl.GeneratorPackageImpl#getMapValue()
		...
		/**
		 * The meta object literal for the '<em><b>Is Correct Value</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation MAP_VALUE___IS_CORRECT_VALUE = eINSTANCE.getMapValue__IsCorrectValue();
		 ...
		 * @generated
		 */
		EAttribute HASSOCIATION__SOURCE = eINSTANCE.getHAssociation_Source();
		 ...
		 * @generated
		 */
		EClass HLEGEND = eINSTANCE.getHLegend();
		 ...
		 * @generated
		 */
		EAttribute HLEGEND__NB_MISSING_ELEMENTS = eINSTANCE.getHLegend_NbMissingElements();
		 ...
		 * @generated
		 */
		EAttribute HLEGEND__MISSING = eINSTANCE.getHLegend_Missing();

		/**
		 * The meta object literal for the '{@link generator.impl.GLocateImpl <em>GLocate</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see generator.impl.GLocateImpl
		 * @see generator.impl.GeneratorPackageImpl#getGLocate()
		 * @generated
		 */
		EClass GLOCATE = eINSTANCE.getGLocate();
		 ...
		 * @generated
		 */
		EAttribute GLOCATE__NB_EXPECTED_ANSWERS = eINSTANCE.getGLocate_NbExpectedAnswers();
		 ...
		 * @generated
		 */
		EAttribute GLOCATE__LEARNERS_CHOICES = eINSTANCE.getGLocate_LearnersChoices();
		 ...
		 * @generated
		 */
		EAttribute GLOCATE__GRAPHIC_TASK = eINSTANCE.getGLocate_GraphicTask();
		 ...
		 * @generated
		 */
		EClass MAP_SOLUTION = eINSTANCE.getMapSolution();
		 ...
		 * @generated
		 */
		EAttribute MAP_SOLUTION__VALUE = eINSTANCE.getMapSolution_Value();

		/**
		 * The meta object literal for the '<em><b>Map Position</b></em>' reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference MAP_SOLUTION__MAP_POSITION = eINSTANCE.getMapSolution_MapPosition();
		...
		/**
		 * The meta object literal for the '<em><b>Map Value</b></em>' containment reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference ENTRY_SOLUCE_PARAM__MAP_VALUE = eINSTANCE.getEntrySoluceParam_MapValue();
		 ...
		 * @generated
		 */
		EOperation ORDERING_TASK___NB_EXPECTED_ANSWERS = eINSTANCE.getOrderingTask__NbExpectedAnswers();
