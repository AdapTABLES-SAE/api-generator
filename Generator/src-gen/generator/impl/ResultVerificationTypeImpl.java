...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Result Verification Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link generator.impl.ResultVerificationTypeImpl#getNbFalseProposition <em>Nb False Proposition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResultVerificationTypeImpl extends VerificationTypeImpl implements ResultVerificationType {
	/**
	 ...
	 * @generated
	 */
	public ResultVerificationTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return GeneratorPackage.Literals.RESULT_VERIFICATION_TYPE;
	}
	...
	public void setNbFalseProposition(int newNbFalseProposition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					GeneratorPackage.RESULT_VERIFICATION_TYPE__NB_FALSE_PROPOSITION, oldNbFalseProposition,
					nbFalseProposition));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case GeneratorPackage.RESULT_VERIFICATION_TYPE__NB_FALSE_PROPOSITION:
