...
public class RelationImpl extends MinimalEObjectImpl.Container implements Relation {
	 ...
	 * @ordered
	 */
	protected static final ETaskType TASK_EDEFAULT = ETaskType.COMPLETE;
	...
	protected EClass eStaticClass() {
		return GeneratorPackage.Literals.RELATION;
	}
	 ...
	 * @generated
	 */
	public void setTask(ETaskType newTask) {
		ETaskType oldTask = task;
		task = newTask == null ? TASK_EDEFAULT : newTask;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorPackage.RELATION__TASK, oldTask, task));
	}
	...
	public NotificationChain basicSetCondition(Condition newCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					GeneratorPackage.RELATION__CONDITION, oldCondition, newCondition);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newCondition != condition) {
			...
			if (condition != null)
				msgs = ((InternalEObject) condition).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - GeneratorPackage.RELATION__CONDITION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorPackage.RELATION__CONDITION, newCondition,
					newCondition));
	}
