 ...
 * </p>
 * <ul>
 *   <li>{@link generator.impl.IdentificationTaskImpl#getPercentOfApparition <em>Percent Of Apparition</em>}</li>
 *   <li>{@link generator.impl.IdentificationTaskImpl#getNbConsecutiveSuccess <em>Nb Consecutive Success</em>}</li>
 *   <li>{@link generator.impl.IdentificationTaskImpl#getResponseModality <em>Response Modality</em>}</li>
 *   <li>{@link generator.impl.IdentificationTaskImpl#getID <em>ID</em>}</li>
 *   <li>{@link generator.impl.IdentificationTaskImpl#getMaxTime <em>Max Time</em>}</li>
 ...
 * @generated
 */
public abstract class IdentificationTaskImpl extends MinimalEObjectImpl.Container implements IdentificationTask {
	/**
	...
	public void setPercentOfApparition(int newPercentOfApparition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					GeneratorPackage.IDENTIFICATION_TASK__PERCENT_OF_APPARITION, oldPercentOfApparition,
					percentOfApparition));
	}
	...
	public void setNbConsecutiveSuccess(int newNbConsecutiveSuccess) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					GeneratorPackage.IDENTIFICATION_TASK__NB_CONSECUTIVE_SUCCESS, oldNbConsecutiveSuccess,
	...
	public NotificationChain basicSetResponseModality(ResponseModality newResponseModality, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					GeneratorPackage.IDENTIFICATION_TASK__RESPONSE_MODALITY, oldResponseModality, newResponseModality);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newResponseModality != responseModality) {
			...
			if (responseModality != null)
				msgs = ((InternalEObject) responseModality).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - GeneratorPackage.IDENTIFICATION_TASK__RESPONSE_MODALITY, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					GeneratorPackage.IDENTIFICATION_TASK__RESPONSE_MODALITY, newResponseModality, newResponseModality));
	}
	...
	public void setID(String newID) {
		...
		idESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorPackage.IDENTIFICATION_TASK__ID, oldID, id,
					!oldIDESet));
	}
	...
	public void unsetID() {
		...
		idESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, GeneratorPackage.IDENTIFICATION_TASK__ID, oldID,
	...
	public void setMaxTime(int newMaxTime) {
		...
		maxTime = newMaxTime;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorPackage.IDENTIFICATION_TASK__MAX_TIME,
					oldMaxTime, maxTime));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case GeneratorPackage.IDENTIFICATION_TASK__RESPONSE_MODALITY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case GeneratorPackage.IDENTIFICATION_TASK__PERCENT_OF_APPARITION:
			return getPercentOfApparition();
		case GeneratorPackage.IDENTIFICATION_TASK__NB_CONSECUTIVE_SUCCESS:
			return getNbConsecutiveSuccess();
		case GeneratorPackage.IDENTIFICATION_TASK__RESPONSE_MODALITY:
			return getResponseModality();
		case GeneratorPackage.IDENTIFICATION_TASK__ID:
			return getID();
		case GeneratorPackage.IDENTIFICATION_TASK__MAX_TIME:
			return getMaxTime();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case GeneratorPackage.IDENTIFICATION_TASK___IS_GRAPHIC_TASK:
