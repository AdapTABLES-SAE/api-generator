 ...
 *   <li>{@link generator.impl.MTCompletion1Impl#isCheckLearnerAction <em>Check Learner Action</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MTCompletion1Impl extends CompletionTaskImpl implements MTCompletion1 {
	...
	public void setCheckLearnerAction(boolean newCheckLearnerAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorPackage.MT_COMPLETION1__CHECK_LEARNER_ACTION,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case GeneratorPackage.MT_COMPLETION1__CHECK_LEARNER_ACTION:
