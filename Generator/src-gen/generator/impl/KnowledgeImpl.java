 ...
 * </p>
 * <ul>
 *   <li>{@link generator.impl.KnowledgeImpl#getName <em>Name</em>}</li>
 *   <li>{@link generator.impl.KnowledgeImpl#getKnowledgefacts <em>Knowledgefacts</em>}</li>
 * </ul>
 *
 * @generated
 */
public class KnowledgeImpl extends MinimalEObjectImpl.Container implements Knowledge {
	...
	protected EClass eStaticClass() {
		return GeneratorPackage.Literals.KNOWLEDGE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneratorPackage.KNOWLEDGE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case GeneratorPackage.KNOWLEDGE__NAME:
			return getName();
		case GeneratorPackage.KNOWLEDGE__KNOWLEDGEFACTS:
